...
function SnakeTailGeometry() {
  ...
  const tailFaceHBD = VERT.verticesH.concat(VERT.verticesD, VERT.verticesB)
  const tailFaceHDC = VERT.verticesH.concat(VERT.verticesC, VERT.verticesD)
  const tailFaceHFE = VERT.verticesH.concat(VERT.verticesF, VERT.verticesE)
  const tailFaceHFB = VERT.verticesH.concat(VERT.verticesB, VERT.verticesF)
  const tailFaceHCG = VERT.verticesH.concat(VERT.verticesG, VERT.verticesC)
  const tailFaceHGE = VERT.verticesH.concat(VERT.verticesE, VERT.verticesG)
